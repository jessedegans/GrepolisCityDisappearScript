...
function go() {
    ...
    n > 79 ? (console.log("hout kan!"), (d.style.backgroundColor = "green")) : (console.log("Hout te laag : " + n), (d.style.backgroundColor = "red"));
    var _ = parseInt(g.innerText) - parseInt(a.innerText);
    _ > 79 ? (console.log("Steen kan!"), (p.style.backgroundColor = "green")) : (console.log("Steen te laag : " + _), (p.style.backgroundColor = "red"));
    var c = parseInt(t.innerText) - parseInt(i.innerText);
    c > 79 ? (console.log("Zilver kan!"), (o.style.backgroundColor = "green")) : (console.log("Zilver te laag : " + c), (o.style.backgroundColor = "red"));
}
